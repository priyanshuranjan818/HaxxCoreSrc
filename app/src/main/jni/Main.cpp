...
Java_com_zenin_activity_LoginActivity_ziplink(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(oxorany("https://github.com/priyanshuranjan818/ZENIN/releases/download/azan/"));
}
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_zenin_BoxApplication_getSdkKey(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(oxorany("JaatBhaiOp"));//sdk key 
}
